            ...
            try{
              ...
              VALUES (:username, :email, :password, now())";
                ...
                if($statement->rowCount() == 1){
                    ...
                    <p><a href= "http://localhost/insidematters/activate.php?id='.$encode_id.'"> Confirm Email</a></p>

                    <p><strong>&copy;2020 INSIDE MATTERS</strong></p>
                    </body>
                    </html>';

                    $mail->addAddress($email, $username);
                    $mail->Subject = "Message from INSIDE MATTERS";
                    $mail->Body = $mail_body;
