                ...
                if($rs = $statement->fetch()){
                    ...
                    $mail_body = '<html>
                        <body style="background-color:#CCCCCC; color:#000; font-family: Arial, Helvetica, sans-serif;
                                            line-height:1.8em;">
                        <h2>User Authentication: INSIDE MATTERS Secured Login System</h2>
                        ...
                        <p><a href= "http://localhost/insidematters/forgot_password.php"> Reset Password</a></p>
                        <p><strong>&copy;'.date('Y').' INSIDE MATTERS</strong></p>
                        </body>
                        </html>';

                    $mail->addAddress($email, $username);
                    $mail->Subject = "Password Recovery Message from INSIDE MATTERS";
                    $mail->Body = $mail_body;
