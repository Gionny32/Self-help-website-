...
if(isset($_POST["Submit"])){
  ...
  if(empty($PostTitle)){
    ...
    $_SESSION["ErrorMessage"]= "Recepie Title should be greater than 5 characters";
    Redirect_to("post.php");
  }elseif (strlen($PostText)>9999) {
    $_SESSION["ErrorMessage"]= "Recepie Description should be less than than 1000 characters";
    Redirect_to("post.php");
  }else{
 ...
 ?>
    ...
    <body>
          <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
            ...
            <!-- PAGE HEADER -->
         <header id="page-header-6">
            <div class="container">
              <div class="row">
                <div class="col-md-6 m-auto text-center"><br>
                  <h1><i class="fas fa-edit" style="color:#27aael;"></i>Edit Recepie </h1>
                  <p>    </p>
                </div>
              </div>
            </div>
        ...
        <div class="card bg-secondary text-light mb-3">
          <div class="card-body bg-dark">
            <div class="form-group">
              <label for="title"> <span class="FieldInfo"> Recipe Title: </span></label>
            ...
            <div class="form-group">
              <label for="Post"> <span class="FieldInfo"> Recipe Description: </span></label>
