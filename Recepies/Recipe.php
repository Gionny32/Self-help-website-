...
<body>
    <!DOCTYPE html>
      ...
      <!-- PAGE HEADER -->
     <header id="page-header-10">
        <div class="container pt-5 ">
          <div class="row">
            <div class="col-md-6 m-auto text-center"><br>
              <h1><i class="fas fa-edit" style="color:#27aael;"></i>Read Our Recipes</h1>
              <p>    </p>
            </div>
          </div>
        </div>
 ...
 <!-- Main Area -->
        ...
        <div class="container py-2 mb-4 ">
            <div class="row mt-4 ">
            <div class="col-sm-8 ">
                <h1> Enjoy our Recipes</h1>
                <h1 class="lead">By Parissa </h1>
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body ">
                    <h4 class="card-title"><?php echo htmlentities ($PostTitle); ?></h4>
                      ...
                      <span style="float:right;" class="badge-dark text-light">Comment <?php echo ApproveCommentsAccordingtoPost($PostId);   ?></span>
                      <hr>


                      <p class="card_text">
                          <?php if (strlen($PostDescription)>150){
                                $PostDescription = substr($PostDescription,0,150)."...";}echo strip_tags($PostDescription); ?></p>
            ...
            <!-- pagination-->
                ...
                <ul class="pagination pagination-md">
                   ...
                   <?php if (isset($Page)){
                      ...
                      ?>
                    <li class="page-item">
                      <a href="Recipes.php?page=<?php echo $Page-1; ?>" class="page-link">&laquo;</a>
                     </li>
                    <?php }}?>
                <?php
                   global $ConnectingDB;
                  ...
                  //echo $PostPagination;
                   for ($i=1; $i <=$PostPagination ; $i++){
                     ...
                     <li class="page-item active">
                      <a href="Recipe.php?page=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a>
                     </li>
                     <?php
                    }else {
                     ?> <li class="page-item">
                  ...
                  <!-- Creating Forward Button-->
                   <?php if (isset($Page)&&!empty($Page)){
                      ...
                      ?>
                    <li class="page-item">
                      <a href="Recipe.php?page=<?php echo $Page+1; ?>" class="page-link">&raquo;</a>
                     </li>
                    <?php }}?>
     ...
     <div class="col-sm-4">
          <div class="card mt-4">
            <div class="card-body">
              <img src="img/parissa.jpg" class="d-block img-fluid mb-3" alt="">
              <div class="text-center">
                Parissa Dunkinson, RD, BSc (Hons) Founder of Inside Matters and Freelance Mental Health Dietitian
              </div>
            </div>
          </div>
          <br>
