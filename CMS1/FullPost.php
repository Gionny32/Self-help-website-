    ...
    <div class="container">
     ...
     <header id="page-header-1">
        <div class="container pt-5">
          <div class="row">
            <div class="col-md-6 mt-auto text-center "><br>
              <h1><i class="fas fa-glasses" style="color:#27aael; "></i>Our Blog</h1>
              <p>    </p>
            </div>
          </div>
        </div>
    ...
    <div class="container py-2 mb-4">
        ...
        <div class="col-sm-8">
            ...
            while ($DataRows = $stmt->fetch()){
             ...
             ?>
            <div class="card mb-3">
                <img src="Uploads/<?php echo strip_tags($Image);?>" Style="max-height:550px;" class="img-fluid  card-img-top"/>
              <div class="card-body ">
                <h4 class="card-title"><?php echo strip_tags($PostTitle); ?></h4>
                <small class="text-muted"> Category:<span class="text-dark"><?php echo strip_tags($Category);?> </span> & Writen by <span class="text-dark"> <?php echo htmlentities($Admin);?></span> On <span class="text-dark"><?php echo strip_tags($DateTime); ?></span></small>
...
<div>
  ...
  <hr>
        ...
        <div class="col-sm-4">
          <div class="card mt-4">
            <div class="card-body">
              <img src="img/parissa copy.jpg" class="d-block img-fluid mb-3" alt="">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              ?>
              <div class="media">
                <img src="Uploads/<?php echo strip_tags($Image); ?>" class="d-block img-fluid align-self-start"  width="90" height="94" alt="">
                <div class="media-body ml-2">
                <a style="text-decoration:none;" href="FullPost.php?id=<?php echo strip_tags($Id) ; ?>" target="_blank">  <h6 class="lead"><?php echo strip_tags($Title); ?></h6> </a>
                  <p class="small"><?php echo strip_tags($DateTime); ?></p>
                </div>
              </div>
              <hr>
              <?php } ?>
