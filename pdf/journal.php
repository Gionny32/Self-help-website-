...
<body>
 ...
 <header id="page-header">
    <div class="container">
      <div class="row">
        <div class="col-md-6 m-auto text-center"><br>
          <h1><i class="fas fa-edit" style="color:#27aael;">Food and Mood Journal</i></h1>
          <p>    </p>
        </div>
      </div>
    </div>
    ...
    <div id="myDIV" class="header">
      <h2 style="margin:5px">My Journal List</h2>
    ...
    <ul id="myUL" class="checked">
      <li>Hit the gym</li>
      <li class="checked">What to eat</li>
      <li class="checked">Meet George</li>
        ...
        <div class="card-body">
          ...
          for ($a = 2; $a < count($files); $a++)
          {
              ...
              <p>
                  ...
                  <br>
                  <a  href="upload/<?php echo $files[$a]; ?>" download="<?php echo $files[$a]; ?>" class="btn btn-primary">
